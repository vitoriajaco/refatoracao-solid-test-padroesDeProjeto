...
public class PetService {
    ...
    public void listarPetsDoAbrigo() throws IOException, InterruptedException {
        ...
        Pet[] pets =  new ObjectMapper().readValue(responseBody, Pet[].class); //Precisa mostrar qual classe de array o jackson datagrid vai usar por debaixo dos panos, pois o readValue espera um tipo Class
